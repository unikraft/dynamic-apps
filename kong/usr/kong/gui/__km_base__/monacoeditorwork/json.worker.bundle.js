...
(() => {
  ...
  var encodeTable2 = (_a = {}, _a[58] = "%3A", _a[47] = "%2F", _a[63] = "%3F", _a[35] = "%23", _a[91] = "%5B", _a[93] = "%5D", _a[64] = "%40", _a[33] = "%21", _a[36] = "%24", _a[38] = "%26", _a[39] = "%27", _a[40] = "%28", _a[41] = "%29", _a[42] = "%2A", _a[43] = "%2B", _a[44] = "%2C", _a[59] = "%3B", _a[61] = "%3D", _a[32] = "%20", _a);
        ...
        if (schema2) {
          if (schema2.errors.length && jsonDocument.root) {
            ...
            if (property && property.keyNode.value === "$schema") {
              ...
              addProblem(Diagnostic.create(range, schema2.errors[0], DiagnosticSeverity.Warning, ErrorCode.SchemaResolveError));
            } else {
          ...
          node.properties.forEach(function(property2) {
            ...
            if (valueNode) {
              if (limit > 0) {
                ...
                var symbol = { name: _this.getKeyLabel(property2), kind: _this.getSymbolKind(valueNode.type), range: range2, selectionRange: selectionRange2, children: [] };
                result2.push(symbol);
      ...
      return __awaiter2(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          ...
          if (document) {
            ...
            return [2, this._languageService.doValidation(document, jsonDocument)];
          }
