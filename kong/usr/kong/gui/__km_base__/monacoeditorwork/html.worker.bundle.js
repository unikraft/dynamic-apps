...
(() => {
  ...
  var safeProcess = typeof process === "undefined" ? {
    ...
    env: /* @__PURE__ */ Object.create(null),
    get platform() {
  ...
  var HTMLCompletion = function() {
    ...
    HTMLCompletion2.prototype._doComplete = function(document, position, htmlDocument, settings) {
        ...
        dataProviders.forEach(function(provider) {
          provider.provideTags().forEach(function(tag2) {
            result.items.push({
              label: "/" + tag2.name,
              kind: CompletionItemKind2.Property,
              documentation: generateDocumentation(tag2, doesSupportMarkdown),
              filterText: "/" + tag2 + closeTag,
              textEdit: TextEdit.replace(range, "/" + tag2 + closeTag),
              insertTextFormat: InsertTextFormat.PlainText
            });
          });
        });
      ...
      function collectAttributeNameSuggestions(nameStart, nameEnd) {
        ...
        var seenAttributes = /* @__PURE__ */ Object.create(null);
        dataProviders.forEach(function(provider) {
        ...
        var _loop_1 = function(provider2) {
          ...
          provider2.provideTags().forEach(function(tag2) {
            if (tag2.name.toLowerCase() === currTag.toLowerCase()) {
              var markupContent = generateDocumentation(tag2, doesSupportMarkdown);
              if (!markupContent) {
                markupContent = {
                  kind: doesSupportMarkdown ? "markdown" : "plaintext",
                  value: ""
        ...
        var _loop_2 = function(provider2) {
          ...
          provider2.provideAttributes(currTag).forEach(function(attr2) {
            if (currAttr === attr2.name && attr2.description) {
              var contentsDoc = generateDocumentation(attr2, doesSupportMarkdown);
              if (contentsDoc) {
        ...
        var _loop_3 = function(provider2) {
          ...
          provider2.provideValues(currTag, currAttr).forEach(function(attrValue2) {
            if (currAttrValue === attrValue2.name && attrValue2.description) {
              var contentsDoc = generateDocumentation(attrValue2, doesSupportMarkdown);
              if (contentsDoc) {
                hover = { contents: contentsDoc, range };
              } else {
                hover = null;
  ...
  if (typeof process === "object") {
    ...
    isWindows2 = userAgent.indexOf("Windows") >= 0;
  }
  var userAgent;
  ...
  var _regexp2 = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
  var URI2 = function() {
    function URI3(schemeOrData, authority, path, query, fragment, _strict) {
      if (_strict === void 0) {
        _strict = false;
      }
      if (typeof schemeOrData === "object") {
    ...
    URI3.parse = function(value, _strict) {
      ...
      var match = _regexp2.exec(value);
      if (!match) {
        return new _URI(_empty2, _empty2, _empty2, _empty2, _empty2);
      }
      return new _URI(match[2] || _empty2, percentDecode2(match[4] || _empty2), percentDecode2(match[5] || _empty2), percentDecode2(match[7] || _empty2), percentDecode2(match[9] || _empty2), _strict);
    };
    URI3.file = function(path) {
      var authority = _empty2;
      if (isWindows2) {
        path = path.replace(/\\/g, _slash2);
      }
      if (path[0] === _slash2 && path[1] === _slash2) {
        var idx = path.indexOf(_slash2, 2);
        if (idx === -1) {
          authority = path.substring(2);
          path = _slash2;
        } else {
      ...
      return new _URI("file", authority, path, _empty2, _empty2);
    };
    ...
    URI3.revive = function(data) {
      if (!data) {
        ...
        result._formatted = data.external;
        result._fsPath = data._sep === _pathSepMarker2 ? data.fsPath : null;
        return result;
      }
    };
    return URI3;
  }();
  var _pathSepMarker2 = isWindows2 ? 1 : void 0;
  ...
  var encodeTable2 = (_a2 = {}, _a2[58] = "%3A", _a2[47] = "%2F", _a2[63] = "%3F", _a2[35] = "%23", _a2[91] = "%5B", _a2[93] = "%5D", _a2[64] = "%40", _a2[33] = "%21", _a2[36] = "%24", _a2[38] = "%26", _a2[39] = "%27", _a2[40] = "%28", _a2[41] = "%29", _a2[42] = "%2A", _a2[43] = "%2B", _a2[44] = "%2C", _a2[59] = "%3B", _a2[61] = "%3D", _a2[32] = "%20", _a2);
  function encodeURIComponentFast2(uriComponent, allowSlash) {
    var res = void 0;
  ...
  function _asFormatted2(uri, skipEncoding) {
    var encoder = !skipEncoding ? encodeURIComponentFast2 : encodeURIComponentMinimal2;
    var res = "";
    ...
    if (fragment) {
      res += "#";
      res += !skipEncoding ? encodeURIComponentFast2(fragment, false) : fragment;
    }
    return res;
  }
  ...
  function percentDecode2(str) {
    ...
    return str.replace(_rEncodedAsHex2, function(match) {
      return decodeURIComponentGraceful2(match);
    });
  }
